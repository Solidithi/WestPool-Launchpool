    ...
    return (
        <div>
            ...
            <div className="mt-10 flex justify-center">
                <div className="border box-border w-7/12 bg-[#3966a9] text-white rounded-2xl text-2xl mb-10">
                    ...
                    <div className="flex flex-row space-x-3 justify-center items-center mb-8">
                        <div className="btn w-5/12 bg-[#ffffff] hover:bg-gray-500 rounded-2xl"
                            onClick={handleBack}
                        >
                            Back
                        </div>
